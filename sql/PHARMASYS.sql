...
CREATE TABLE NOTA_FISCAL (
    ...
    CONSTRAINT FK_NOTA_FISCAL_FUNCIONARIO
        FOREIGN KEY (ID_FUNCIONARIO)
        REFERENCES FUNCIONARIO (ID_FUNCIONARIO),
    CONSTRAINT FK_NOTA_FISCAL_PEDIDO
...
CREATE TABLE ITEM_NOTA_FISCAL (
    ID_ITEM_NOTA_FISCAL INT AUTO_INCREMENT NOT NULL,
    ...
    CONSTRAINT FK_ITEM_NOTA_FISCAL_NOTA
        FOREIGN KEY (ID_NOTA_FISCAL)
        REFERENCES NOTA_FISCAL (ID_NOTA_FISCAL)
        ON DELETE CASCADE,
    CONSTRAINT FK_ITEM_NOTA_FISCAL_MEDICAMENTO
        FOREIGN KEY (SKU_MEDICAMENTO)
        REFERENCES MEDICAMENTO (SKU)
) ENGINE=InnoDB;

-- -----------------------------------------------------
-- TABELA ITEM_PEDIDO_MED
-- -----------------------------------------------------

CREATE TABLE IF NOT EXISTS ITEM_PEDIDO_MED (
    ID_ITEM_PEDIDO_MED INT AUTO_INCREMENT NOT NULL,
    ID_PEDIDO INT NOT NULL,
    SKU_MEDICAMENTO VARCHAR(45) NOT NULL,
    QUANTIDADE INT NOT NULL,
    ...
    PRIMARY KEY (ID_ITEM_PEDIDO_MED),

    CONSTRAINT FK_ITEM_PEDIDO_MED_PEDIDO
        FOREIGN KEY (ID_PEDIDO)
        REFERENCES PEDIDO (ID_PEDIDO)
        ON DELETE CASCADE,

    CONSTRAINT FK_ITEM_PEDIDO_MED_MEDICAMENTO
        FOREIGN KEY (SKU_MEDICAMENTO)
        REFERENCES MEDICAMENTO (SKU)
) ENGINE=InnoDB;
...
CREATE TABLE IF NOT EXISTS MEDICAMENTO_COMPRIMIDO (
    SKU VARCHAR(45) NOT NULL,
    QUANTIDADE_COMPRIMIDOS INT NOT NULL,
    PRIMARY KEY (SKU),
    CONSTRAINT FK_MEDICAMENTO_COMPRIMIDO
    FOREIGN KEY (SKU)
    REFERENCES MEDICAMENTO (SKU)
    ON DELETE CASCADE
    ON UPDATE CASCADE
...
CREATE TABLE IF NOT EXISTS MEDICAMENTO_INJETAVEL (
    SKU VARCHAR(45) NOT NULL,
    VIA_ADMINISTRACAO VARCHAR(45) NOT NULL,
    TEMPERATURA_MINIMA DOUBLE NOT NULL,
    TEMPERATURA_MAXIMA DOUBLE NOT NULL,
    PRIMARY KEY (SKU),
    CONSTRAINT FK_MEDICAMENTO_INJETAVEL
    FOREIGN KEY (SKU)
    REFERENCES MEDICAMENTO (SKU)
    ON DELETE CASCADE
    ON UPDATE CASCADE
...
CREATE TABLE IF NOT EXISTS MEDICAMENTO_LIQUIDO (
    SKU VARCHAR(45) NOT NULL,
    VOLUME_ML DOUBLE NOT NULL,
    TIPO_RECIPIENTE VARCHAR(45) NOT NULL,
    PRIMARY KEY (SKU),
    CONSTRAINT FK_MEDICAMENTO_LIQUIDO
    FOREIGN KEY (SKU)
    REFERENCES MEDICAMENTO (SKU)
    ON DELETE CASCADE
    ON UPDATE CASCADE
...
CREATE TABLE IF NOT EXISTS MEDICAMENTO_TOPICO (
    SKU VARCHAR(45) NOT NULL,
    PESO_GRAMAS DOUBLE NOT NULL,
    TIPO_EMBALAGEM VARCHAR(45) NOT NULL,
    PRIMARY KEY (SKU),
    CONSTRAINT FK_MEDICAMENTO_TOPICO
    FOREIGN KEY (SKU)
    REFERENCES MEDICAMENTO (SKU)
    ON DELETE CASCADE
    ON UPDATE CASCADE
...
CREATE INDEX IDX_LOTE_SKU ON LOTE (SKU_MEDICAMENTO);
