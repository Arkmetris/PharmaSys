...
ALTER TABLE FUNCIONARIO
  ADD COLUMN SENHA VARCHAR(255) NULL AFTER TELEFONE_ID;
-- -----------------------------------------------------
-- TABELA DEPENDENTE
-- -----------------------------------------------------
...
ALTER TABLE FORNECEDOR
  ADD COLUMN ESTADO VARCHAR(50) DEFAULT NULL,
  ADD COLUMN CEP VARCHAR(20) DEFAULT NULL,
  ADD COLUMN RUA VARCHAR(150) DEFAULT NULL,
...
CREATE TABLE MEDICAMENTO (
  ...
  LOTE_ID INT,
  PRIMARY KEY (SKU),
  CONSTRAINT fk_medicamento_lote
  FOREIGN KEY (LOTE_ID)
  REFERENCES LOTE (NUMERO_LOTE)
) ENGINE=InnoDB;

ALTER TABLE MEDICAMENTO
  ADD COLUMN ESTOQUE_ATUAL INT DEFAULT 0,
  ADD COLUMN PRECO DECIMAL(10,2) DEFAULT 0.00,
  ADD COLUMN INATIVO TINYINT(1) DEFAULT 0;
-- -----------------------------------------------------
-- TABELA FORNECE (N x N)
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- TABELA ATENDIDO_PEDIDO_FUNCIONARIO (N x N)
-- -----------------------------------------------------
